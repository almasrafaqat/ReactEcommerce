...
class Cart extends Component {
          ...
          if(city.length===0){
               ...
               axios.post(AppURL.CartOrder,MyFromData).then(response=>{
                    if(response.data===1){
                         ...
                         cogoToast.error("Something Wrong! Try Aagain",{position:'top-right'});
                    }
               })
               .catch(error=>{
                    cogoToast.error(error+" Your Request is not done ! Try Aagain",{position:'top-right'});
               })
          }
     ...
     componentDidMount(){
          let email = this.props.user.email;
          axios.get(AppURL.CartList(email)).then(response=>{
                                   ...
                                   <div className="container-fluid ">
                                        ...
                                        <div className="row">
                                             <div className="col-md-12 p-1 col-lg-12 col-sm-12 col-12">
                                                  ...
                                                  <option value="dammam">Damman </option>
                                                  <option value="hafar">Hafar Al Batin </option>
